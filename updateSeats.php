<?php
session_start();
  if (($_POST['Update_Flight'])) {
    $flightName=$_POST['FlightName'];
    $date=$_POST['Date'];
    $seats=$_POST['Seats'];
    
      $con=mysqli_connect("localhost", "root", "root","Airline");
      $query=mysqli_query($con,"UPDATE Flights SET Available_seats='$seats' WHERE Flight_name='$flightName' AND Date='$date' ");
   ...
   //  //     $dbadminname= $row['Admin_name'];
      ...
      echo "<script>alert('Seats update Successful!!'); window.location.href='adminControl.php';</script>";
      mysqli_close($con);
    // }
    // else
...
<div class="container-fluid bg-3 text-center" style="padding-top: 100px;
  ...
  <div class="row">
    ...
    <p><input type="submit" value="Update Seats" name="Update_Flight" required=""></p>
    </form>
