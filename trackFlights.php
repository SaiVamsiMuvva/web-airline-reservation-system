  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="trackFlights.php">Track Flights</a></li>
...
<div class="container-fluid bg-3 text-center" style="padding-top: 100px;
      padding-bottom: 30px;"> 
  <h3>Track Flight Details</h3><br>
  <div class="row">
    <div class="col-sm-12">

    <form method="post">
    <p>Flight Number&nbsp;&nbsp;<input type="text" name="FlightNumber" required></p>
    <p>Trip Date&nbsp;&nbsp;<input type="date" name="FlightDate" required=""></p>
    <p><input type="Submit" value="Track Details" name="TrackDetails"></p>
    </form>

    <?php
session_start();
if (($_POST['TrackDetails'])) {
...
$query=mysqli_query($con,"SELECT * FROM Flights WHERE Flight_name = '$flightNumber' AND Date = '$flightDate'");
$numrows = mysqli_num_rows($query);

if ($numrows >0) {
    // output data of each row
  
  echo " <h3>Flight results matching your search</h3><br>";
